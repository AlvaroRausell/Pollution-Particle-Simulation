...
var NUM_LAYERS = 3;
function setup() {
  sketchWidth = document.getElementById(CONTAINER_ID).getBoundingClientRect()
    .width; //document.getElementById(CONTAINER_ID).width;
  sketchHeight = document.getElementById(CONTAINER_ID).getBoundingClientRect()
...
function windowResized() {
  resizeCanvas(
    document.getElementById(CONTAINER_ID).getBoundingClientRect().width,
    document.getElementById(CONTAINER_ID).getBoundingClientRect().height
  );
}
function draw() {
  background(255, 125);
